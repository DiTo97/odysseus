...
def single_run(conf_tuple):
    ...
    sim_general_conf = conf_tuple[0]   # Dict with a combination from sim_conf.General
    sim_scenario_conf = conf_tuple[1]  # sim_conf.{Single_run|Multiple_runs}
    sim_scenario_name = conf_tuple[2]  # sim_conf.General['sim_scenario_name']
