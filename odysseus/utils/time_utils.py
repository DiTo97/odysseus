...
def get_time_group_columns(trips_df_norm):
    ...
    if "start_year" not in trips_df_norm:
        trips_df_norm.loc[:, "start_year"] = trips_df_norm.loc[:, "year"]

    if "end_year" not in trips_df_norm:
        trips_df_norm.loc[:, "end_year"]   = trips_df_norm.loc[:, "year"]
    ...
    if "start_month" not in trips_df_norm:
        trips_df_norm.loc[:, "start_month"] = trips_df_norm.loc[:, "month"]

    if "end_month" not in trips_df_norm:
        trips_df_norm.loc[:, "end_month"]   = trips_df_norm.loc[:, "month"]
